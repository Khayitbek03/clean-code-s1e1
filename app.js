...
var taskInput=document.getElementById(".tasks__input_new-task");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.getElementById(".tasks__list_incomplete");//ul of #incompleteTasks
var completedTasksHolder=document.getElementById(".tasks__list_completed");//completed-tasks
